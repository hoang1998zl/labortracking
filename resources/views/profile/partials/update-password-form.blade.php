<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Hãy đảm bảo tài khoản của bạn đang sử dụng mật khẩu đủ dài, ngẫu nhiên để giữ an toàn.') }}
        </p>
    </header>

    <form method="post" action="{{ route('password.update') }}" class="password-update mt-6 space-y-6">
        @csrf
        @method('put')
