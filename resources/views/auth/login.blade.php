<div id="modal_login" class="w-screen h-screen fixed top-0 left-0 z-50 bg-black bg-opacity-30 hidden">
    <div class="w-full h-full relative flex justify-center items-center">
        <div class="backdrop w-full h-full absolute z-10" onclick="Modal_Login_Function(false)"></div>
        <div class="w-11/12 lg:w-[600px] bg-white shadow-2xl rounded-3xl z-20 px-5 py-5 relative">
